        ...
        <g fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
          <g>
            ...
            <path
              fill={PRIMARY_MAIN}
              fillRule="nonzero"
              d="M231.46 99.296l-185.935-5.29C39.175 93.825 34 98.163 34 103.698v159.882c0 5.534 5.175 9.742 11.526 9.4l185.934-10.028c5.28-.284 9.54-4.576 9.54-9.585v-144.73c0-5.012-4.26-9.194-9.54-9.342z"
              opacity="0.12"
            />
            <path
              fill="#FFF"
              fillRule="nonzero"
              d="M231.476 93.405l-180.3-5.278C45.02 87.947 40 92.277 40 97.797v159.496c0 5.521 5.019 9.718 11.176 9.377l180.3-10.003c5.12-.284 9.251-4.565 9.251-9.563v-144.38c0-5-4.131-9.172-9.251-9.32z"
            />
            <path
              fill="#DFE3E8"
              fillRule="nonzero"
              d="M139.131 203.668a44.088 44.088 0 01-20.975-4.875 42.576 42.576 0 01-16.793-15.549 40.532 40.532 0 01-5.98-21.153c0-23.36 19.874-41.848 43.748-41.227 23.283.606 41.804 19.248 41.804 41.569 0 22.322-18.521 40.816-41.804 41.235z"
              opacity="0.48"
            />
            <path
              fill="#C4CDD5"
            ...
            <path
              fill="#919EAB"
              fillRule="nonzero"
              d="M120.797 136.682a1.812 1.812 0 01-.525 1.378l-1.858 1.858 16.887 16.893a2.174 2.174 0 010 3.074l-29.734-29.744 2.545-2.546a1.8 1.8 0 012.391-.14l9.613 7.917c.404.32.651.797.681 1.31z"
            />
            <path
              fill={PRIMARY_MAIN}
              fillRule="nonzero"
            ...
            <path
              fill="#DFE3E8"
              fillRule="nonzero"
              d="M200.304 235.213a4.461 4.461 0 01-4.271 4.417l-106.87 4.074c-2.652.107-4.807-1.842-4.807-4.341v-16.97c0-2.499 2.155-4.579 4.807-4.644l106.87-2.64a4.142 4.142 0 013.018 1.168 4.128 4.128 0 011.253 2.98v15.956z"
              opacity="0.72"
            />
            <path
              fill="url(#linearGradient-2)"
              fillRule="nonzero"
              d="M183.706 290.362v3.306c0 .847-.436 1.546-1.011 1.622l-51.671 4.676a3.72 3.72 0 01-1.448-.087l-36.002-6.775c-.383-.1-.665-.6-.665-1.177v-3.494l38.198-4.727 4.917-2.324 4.889.703 2.887-.552 6.599 1.917 33.307 6.912z"
            />
            <path
              fill="url(#linearGradient-3)"
              fillRule="nonzero"
              d="M183.707 290.362v3.307c0 .846-.436 1.545-1.012 1.621l-51.668 4.676a3.684 3.684 0 01-1.148-.024v-17.813l6.148-.749 4.889.703 2.886-.552 6.598 1.917 33.307 6.914z"
              opacity="0.3"
            />
            <path
              fill="url(#linearGradient-4)"
              fillRule="nonzero"
              d="M143.803 281.53l-50.89 6.74 36.707 6.904c.445.115.909.142 1.366.08l52.72-4.892-39.903-8.832z"
            />
            <path
              fill="url(#linearGradient-5)"
              fillRule="nonzero"
              d="M162.459 287.623c0 2.42-7.627 4.302-18.157 4.79-2.657.121-5.499.156-8.447.088-14.491-.333-26.135-3.025-26.135-6.005a.81.81 0 01.02-.214h-.02l.06-.143a.834.834 0 01.054-.139l3.342-8.724 4.037-10.526 5.652-14.753 4.325-11.293 5.381-14.042c.673-1.758 1.922-2.851 3.269-2.851.183-.001.364.019.542.059 1.138.248 2.153 1.272 2.737 2.795l5.427 14.14 4.337 11.441 5.715 15.05 4.106 10.813.065.006 3.42 8.787c.147.239.27.479.27.721z"
            />
            <path
              fill="#FFF"
              fillRule="nonzero"
            ...
            <image width="185" height="300" x="255" y="30" xlinkHref="/static/illustrations/personWithGears.png" />
          </g>
        </g>
      </svg>
    </Box>
