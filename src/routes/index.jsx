  ...
  return useRoutes([
    ...
    },
    {
      ...
      children: [
        ...
        { path: `${PATH_MODULES.auth.profile}`, element: <Profile /> },
        ...
        { path: `${PATH_MODULES.auth.resetPasswordEmail}`, element: <RecoveryPasswordEmail /> },
        { path: PATH_MODULES.auth.resetPasswordForm, element: <RecoveryPasswordForm /> },
      ],
    },
    { path: '*', element: <Navigate to="/404" replace /> },
