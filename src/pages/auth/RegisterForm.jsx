...
// material
import { Box, Card, Stack, Link, Alert, Typography, styled, Grid } from '@mui/material';
...
export default function Register() {
  ...
  console.log(methodsRegister.watch());
  console.log(methodsRegister.formState.errors);
